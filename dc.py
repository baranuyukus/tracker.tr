...
import time
import random
import discord  # discord için gerekli kütüphaneyi ekledik.


# öncelikle pip install - U discord.py diyerek python paketini kuruyoruz.
# discord > ayarlar > görünüm > geliştirici modu açıyoruz.
# TrackerTr sunucu ayarları > widget > sunucuId = 703666065040867388 veya kanalın üstüne sağ klik ID'yi kopyala
...
client = discord.Client()  # instance oluşturuyoruz
# Mesaj atacağımız Channel ID'yi giriyoruz.
channel = client.get_channel(703666065040867388)


@client.event
async def on_message(message):
    # bu iki satır hunharca mesaj atmayı önlüyor sakin sakin teker teker mesaj atıyor bu sayede.
    if message.author == client.user:
        return
    await message.channel.send('BAŞLIYORUZ!')
    while 1 < 2:
        try:
            ...
            if re.search('(?i)SOLD OUT', req1.text):
                ...
                await message.channel.send('Checked-No Stock Linen')
            else:
                print('Attention-Stocked')
                await message.channel.send('Attention-Stocked')
            ...
            if re.search('(?i)SOLD OUT', req2.text):
                ...
                await message.channel.send('Checked-No Stock Slide Bone')
            else:
                print('Attention-Stocked')
                await message.channel.send('Attention-Stocked')
            ...
            if re.search('(?i)SOLD OUT', req3.text):
                ...
                await message.channel.send('Checked-No Stock Slide Earth')
            else:
                print('Attention-Stocked')
                await message.channel.send('Attention-Stocked')
            ...
            if re.search('(?i)SOLD OUT', req4.text):
                ...
                await message.channel.send('Checked-No Stock Slide Resin')
            else:
                print('Attention-Stocked')
                await message.channel.send('Attention-Stocked')
            ...
            if re.search('(?i)SOLD OUT', req5.text):
                ...
                await message.channel.send('Checked-No Stock Boost 700')
            else:
                print('Attention-Stocked')
                await message.channel.send('Attention-Stocked')
            ...
            if re.search('(?i)SOLD OUT', req6.text):
                ...
                await message.channel.send('Checked-No Stock Cinder')
            else:
                await message.channel.send('Attention-Stocked')
            ...
            if re.search('(?i)SOLD OUT', req7.text):
                ...
                await message.channel.send('Checked-No Stock Desert Sage')
            else:
                await message.channel.send('Attention-Stocked')
            ...
            if re.search('(?i)SOLD OUT', req8.text):
                await message.channel.send('Checked-No Stock Flax')
            else:
                await message.channel.send('Attention-Stocked')

        except Exception as e:
            # herhangi bir hata olursa onu da mesaj olarak yazıyor. Opsiyonel kaldırılabilir.
